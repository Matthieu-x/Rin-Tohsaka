...
/*parseMention: {
    ...
    Object.defineProperty(sock, 'jid', {
        get() {
            return sock.user?.id ? sock.decodeJid(sock.user.id) : (sock.user?.jid || null);
        },
        configurable: true,
        enumerable: true
    });
...
export function serialize() {
    ...
    if (!proto?.WebMessageInfo?.prototype) {
        console.warn('[serialize] proto.WebMessageInfo is undefined, skipping serialization')
        return {}
    }
