...
const URL_FOTO_FONDO = 'https://files.catbox.moe/lhce9v.png'

const ANCHO_CARTA = 800
const ALTO_CARTA = 800

const FOTO_X = 275
const FOTO_Y = 130
const FOTO_TAMANO = 250
...
// ============================================================================
// DESCARGA Y REGISTRO DE FUENTES (AUTOMÁTICO)
// ============================================================================
...
const generarCarta = async (fotoUsuarioUrl, nombreUsuario, tipo = 'add') => {
    ...
    ctx.font = `bold 42px ${FAMILIA_BOLD}, sans-serif`
    ctx.fillStyle = '#ffffff'
    ctx.textAlign = 'center'
    ctx.textBaseline = 'middle'
    ctx.fillText(nombreUsuario || 'Usuario', ANCHO_CARTA / 2, TEXTO_Y)

    const subtitulo = tipo === 'add' ? '¡Bienvenido/a!' : '¡Hasta pronto!'
    ctx.font = `italic 28px ${FAMILIA_REGULAR}, sans-serif`
    ctx.fillStyle = '#f0f0f0'
    ctx.fillText(subtitulo, ANCHO_CARTA / 2, TEXTO_Y + 60)
